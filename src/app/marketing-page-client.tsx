...
const heroTypewriterText = "Build AI for Clients. Get Paid.";
...
export default function MarketingPageClient() {
  ...
  useEffect(() => {
    if (typewriterRef.current) {
      typewriterRef.current.textContent = heroTypewriterText; // Set text directly
      typewriterRef.current.classList.remove("typewriter-text"); // Remove class to reset animation
      void typewriterRef.current.offsetWidth; // Force reflow to restart animation
      typewriterRef.current.classList.add("typewriter-text"); // Add class back
    }
  }, []);
  ...
  const socialProofItems = [
    {
      ...
      quote: "Finally, an AI tool I understand! My bakery client loves their new FAQ bot.", delay: "delay-100", aiHint: "woman diverse business"
    },
    {
      type: "metric", metrics: [ { icon: <Zap className="w-5 h-5 sm:w-6 sm:h-6 mb-1 opacity-80"/>, value: "No Code Needed.", label: "Build AI Easily." }, { icon: <ClientIcon className="w-4 h-4 sm:w-5 sm:w-5 mt-2 mb-1 opacity-80"/>, value: "Real Client Value.", label: "Deliver Solutions." } ],
    ...
    },
    {
      ...
      quote: "Added AI chat services to my agency offerings in a weekend. AutoBoss made it simple.", delay: "delay-300", aiHint: "consultant portrait"
    }
  ];
          ...
          <nav className="hidden md:flex gap-1 sm:gap-2 items-center">
            ...
            <Button size="sm" asChild className="btn-gradient-primary font-semibold shadow-md hover:opacity-90 transition-opacity btn-interactive text-xs">
              <Link href="/dashboard" className="flex items-center gap-1">
                 Explore Platform (Free Early Access) <ArrowRight className="h-4 w-4"/>
              </Link>
            </Button>
          </nav>
      ...
      <main className="flex-1">
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10 max-w-screen-xl">
            <div className="max-w-2xl mx-auto space-y-3 md:space-y-4">
              ...
              <p className="text-muted-foreground text-sm sm:text-base max-w-md mx-auto !mb-5 md:!mb-6">
                AutoBoss is the simplest way for anyone to start an AI agency. Create AI solutions for businesses—no coding required. Turn your ambition into income.
              </p>
              <div className="flex flex-col sm:flex-row gap-3 justify-center items-center pt-1">
                <Button size="lg" asChild className="btn-gradient-primary shadow-lg font-bold text-sm px-6 py-2.5 sm:py-3 hover:opacity-90 transition-all duration-300 hover:scale-105 group btn-interactive w-full sm:w-auto">
                  <Link href="/dashboard" className="flex items-center gap-1.5">
                    Explore Platform (Free Early Access)
        ...
        <section ref={valueRef} id="value" className={cn("scroll-reveal section-light-accent w-full py-12 md:py-16 lg:py-20 border-b border-border/50", valueVisible && "visible")}>
            <div className="container mx-auto px-4 md:px-6 text-center max-w-screen-xl">
                <h2 className="marketing-h2 text-card-foreground">Unlock AI Power. Simply.</h2>
                 <p className="section-description !mb-6 md:!mb-8">
                  AutoBoss removes the complexity, so you can focus on delivering value to your clients.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-5 max-w-3xl mx-auto">
                  <SimpleBenefitCard icon={<Zap className="w-5 h-5" />} title="No-Code AI Builder" description="Create powerful AI agents without writing a single line of code." animationDelay="delay-100"/>
                  <SimpleBenefitCard icon={<ClientIcon className="w-5 h-5" />} title="Client-Ready Solutions" description="Deliver real value that businesses need and will pay for." animationDelay="delay-200"/>
                  <SimpleBenefitCard icon={<Rocket className="w-5 h-5" />} title="Fast Agency Launchpad" description="Get your AI business off the ground quickly and efficiently." animationDelay="delay-300"/>
                </div>
            </div>
        </section>
        ...
        <section ref={toolkitRef} id="toolkit" className={cn("scroll-reveal section-dark w-full py-12 md:py-16 lg:py-20", toolkitVisible && "visible")}>
          <div className="container mx-auto px-4 md:px-6 text-center max-w-screen-xl">
            <h2 className="marketing-h2">Your Complete AI Agency Toolkit.</h2>
            <p className="section-description">
              All the essentials to manage clients and build effective AI agents, all in one place.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 md:gap-5 max-w-4xl mx-auto text-left">
              <SimpleBenefitCard icon={<Briefcase className="w-5 h-5"/>} title="Client Workspaces" description="Organize projects & agents for each client easily." animationDelay="delay-100" />
              <SimpleBenefitCard icon={<BotIcon className="w-5 h-5"/>} title="Versatile AI Creation" description="Build chatbots or voice agents tailored to client needs." animationDelay="delay-200" />
              <SimpleBenefitCard icon={<UploadCloud className="w-5 h-5"/>} title="Custom Knowledge Training" description="Train agents with client docs or website content." animationDelay="delay-300" />
              <SimpleBenefitCard icon={<Share2 className="w-5 h-5"/>} title="Simple Deployment" description="Get agents live for clients with no technical fuss." animationDelay="delay-400" />
            </div>
          </div>
        </section>
        ...
        <section ref={howItWorksRef} id="how-it-works" className={cn("scroll-reveal section-light-accent w-full py-12 md:py-16 lg:py-20", howItWorksVisible && "visible")}>
          <div className="container mx-auto px-4 md:px-6 text-center max-w-screen-xl">
            <h2 className="marketing-h2 text-card-foreground">Your Path to an AI Agency.</h2>
            <p className="section-description">
              Follow these simple steps to deliver AI solutions and grow your income.
            </p>
            <div className="relative mx-auto max-w-5xl grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-5 items-stretch step-card-container">
                {[
                    { number: "1", title: "Set Up Your Client", description: "Easily create a dedicated workspace for each client project.", icon: <Users2 className="w-5 h-5 text-electric-teal"/>, animationDelay:"delay-100", hint: "client setup icon" },
                    { number: "2", title: "Build Their AI Agent", description: "Design chatbots or voice agents using simple tools. No coding needed.", icon: <Edit3 className="w-5 h-5 text-neon-lime"/>, animationDelay:"delay-150", hint: "ai agent building icon" },
                    { number: "3", title: "Launch & Start Earning", description: "Deploy the AI solution for your client and begin your income journey.", icon: <CheckCircle className="w-5 h-5 text-primary"/>, animationDelay:"delay-200", hint: "launch success checkmark" },
                ].map((step, index, arr) => {
        ...
        <section ref={videoDemoRef} id="video-demo-placeholder" className={cn("scroll-reveal section-dark w-full py-12 md:py-16 lg:py-20 text-center", videoDemoVisible && "visible")}>
          <div className="container mx-auto px-4 md:px-6 max-w-screen-xl">
            ...
            <p className="section-description mt-1 mb-6">A quick look at how easy it is to build and manage client AI.</p>
            <div className="max-w-2xl mx-auto aspect-video bg-muted/20 rounded-lg shadow-xl flex items-center justify-center text-muted-foreground border border-border/50 relative overflow-hidden cursor-pointer group" data-ai-hint="clean video player interface dark theme">
                ...
                <div className="video-placeholder-text z-10">
                     ...
                     <p className="mt-2 text-xs font-semibold">Watch: No-Code AI Agency Builder</p>
                </div>
            </div>
          </div>
        </section>
        ...
        <section ref={socialProofRef} id="proof" className={cn("scroll-reveal section-light-accent w-full py-12 md:py-16 lg:py-20", socialProofVisible && "visible")}>
            <div className="container mx-auto px-4 md:px-6 text-center max-w-screen-xl">
                <h2 className="marketing-h2 text-card-foreground">Join Others Building Their AI Future.</h2>
                 <p className="section-description">Real people are already using AutoBoss to serve their clients.</p>
        ...
        <section ref={earlyAccessRef} id="early-access" className={cn("scroll-reveal section-dark w-full py-12 md:py-16 lg:py-20", earlyAccessVisible && "visible")}>
          <div className="container mx-auto px-4 md:px-6 text-center max-w-screen-xl">
            <h2 className="marketing-h2">Be an AutoBoss Pioneer: Free Early Access.</h2>
            <div className="max-w-xl mx-auto bg-card/90 dark:bg-card/80 border-border/70 p-4 my-4 sm:my-6 text-left rounded-lg">
              <p className="text-sm text-card-foreground/90">
                 We're offering full, complimentary access to AutoBoss for our founding users. Your insights will help us build the best AI agency platform. This is a limited-time opportunity before we introduce subscription plans. 
                 <Link href="/roadmap" className="font-semibold text-accent hover:underline ml-1">Help shape our roadmap!</Link>
              </p>
            </div>
            <aside className={cn(
              ...
              <p className="italic text-xs text-muted-foreground leading-relaxed">"We're building AutoBoss for you. Your success helps us grow."</p>
          ...
          <div className="container mx-auto px-4 md:px-6 text-center max-w-screen-xl">
            <div className="mx-auto max-w-md space-y-3 bg-card/80 dark:bg-background/70 backdrop-blur-md p-5 sm:p-6 md:p-8 rounded-xl shadow-2xl">
              ...
              <p className="text-muted-foreground text-xs md:text-sm !mb-5">
                Start today with AutoBoss. It's free to explore during our early access period. No complex setups, just results.
              </p>
              <div className="flex flex-col sm:flex-row gap-3 justify-center items-center pt-1">
              ...
              <p className="text-[10px] text-muted-foreground/70 mt-2">No credit card required for early access.</p>
            </div>
          </div>
        </section>
      </main>
