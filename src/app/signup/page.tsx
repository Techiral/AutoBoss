...
import { Loader2, UserPlus, Mail } from "lucide-react"; // Added Mail
...
export default function SignupPage() {
  ...
  const onEmailSubmit: SubmitHandler<FormData> = async (data) => {
    ...
    setIsGoogleSubmitting(false); // Ensure only one submission type is active
  ...
  const handleGoogleSignUp = async () => {
    ...
    setIsSubmitting(false); // Ensure only one submission type is active
    await signInWithGoogle(); // This function handles new user creation too
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-muted/30 p-4">
      ...
      <Card className="w-full max-w-md shadow-xl">
        ...
        <CardContent className="space-y-6">
          ...
          <Button variant="outline" onClick={handleGoogleSignUp} disabled={isSubmitting || isGoogleSubmitting} className="w-full">
