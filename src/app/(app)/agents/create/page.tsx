    ...
    <div className="max-w-2xl mx-auto">
      <Card>
        <CardHeader className="p-4 sm:p-6">
          ...
          <CardDescription className="text-sm">
            ...
            {!selectedTemplate && <Link href="/app/templates-gallery" className="underline hover:text-foreground/80">Browse templates</Link>}
          </CardDescription>
        </CardHeader>
            ...
            {(currentAgentType === 'voice' || currentAgentType === 'hybrid') && (
                <Alert variant="default" className="p-3 text-xs bg-secondary">
                    ...
                    <AlertDescription className="text-xs">
                        For voice agents to use your own Twilio account for calls, ensure your Twilio credentials are set up in <Link href="/settings" className="underline hover:text-foreground/80">User Profile Settings <ExternalLink className="inline w-2.5 h-2.5 ml-0.5"/></Link>.
                    </AlertDescription>
                </Alert>
            )}
             <div className="space-y-1.5">
      ...
      {generatedAgentDetails && (
        <Card className="mt-6 sm:mt-8">
          <CardHeader className="p-4 sm:p-6">
            <CardTitle className="font-headline text-lg sm:text-xl">AI Generated Details (Suggestions)</CardTitle>
